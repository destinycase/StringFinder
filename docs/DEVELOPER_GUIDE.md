...
- **문서 버전:** 1.10 (StringFinder v5.9.22 기준)
- **최종 수정일:** 2026-09-25
- **대상 독자:** 코어 검색 엔진 및 UI/UX 개발자, 기여자(Maintainers & Contributors)

> Documentation baseline: **StringFinder 5.9.22** · Updated: **2026-09-25**
