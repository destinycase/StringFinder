class AppStrings:
    ...
    SETTINGS_GROUP_LOG = "로그 설정"
    SETTINGS_GROUP_PERFORMANCE = "성능(실험실)"
    SETTINGS_GROUP_DATA = "데이터 관리"

    LOG_RETENTION_LABEL = "로그 파일 보존:"
    BTN_DELETE_ALL_LOGS = "전체 로그 삭제"
    MSG_DELETE_LOGS_CONFIRM = "모든 로그 파일을 삭제하시겠습니까?\n(현재 사용 중인 로그 파일 제외)"
    INFO_LOGS_DELETED = "로그 파일이 삭제되었습니다."
    ...
    INFO_CACHE_CLEARED = "캐시가 성공적으로 삭제되었습니다."
    ...
    # Engine Status
    ENGINE_STATUS_RUST = "[Rust 검색 엔진]"
    ENGINE_STATUS_PYTHON = "[Python 검색 엔진]"
