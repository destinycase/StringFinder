...
pub const MODE_BOOLEAN_ONLY: u32 = 1 << 6;

pub type SearchResultCollector = Arc<Mutex<Vec<(String, Vec<SearchMatch>)>>>;
pub type SkippedResultCollector = Arc<Mutex<Vec<(String, String)>>>;
